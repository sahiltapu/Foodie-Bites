        ...
        <Container>
          <Row className="align-items-center">
            <Col lg={6} className="text-center text-lg-start mb-5 mb-lg-0">
              ...
              <h2 className="animate-charcter">save up to 20%</h2>
              <p>
                Experience convenience at your fingertips – download our app
                today and unlock a world of exclusive offers, seamless ordering,
                and personalized delights!
              </p>
              <Link to="/">
                <img
                  src={StoreIOS}
